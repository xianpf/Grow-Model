...
def make_optimizer(cfg, model):
    ...
    for key, value in model.named_parameters():
        ...
        if "embryo_" in key:
            print('xxxxxxxxxxxxxxxxxxxxxxxxpf:', key)
            lr = cfg.SOLVER.BASE_LR * cfg.SOLVER.EMBRYO_LR_FACTOR
            weight_decay = cfg.SOLVER.WEIGHT_DECAY * cfg.SOLVER.EMBRYO_WEIGHT_DECAY_FACTOR
        elif "bias" in key:
...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default="mac/Grow_R_50_FPN_1x.yaml",
        metavar="FILE",
